...
/**
 * Strings for component 'block_xp', language 'en', branch 'MOODLE_34_STABLE'
 *
 * @package   block_xp
...
$string['shortcode:xpiflevel_help'] = 'Refer to the examples below to format this shortcode. When a level is stricly specified, the content will be displayed regardless of the other rules.
