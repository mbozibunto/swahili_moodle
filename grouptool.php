...
/**
 * Strings for component 'grouptool', language 'en', branch 'MOODLE_34_STABLE'
 *
 * @package   grouptool
...
$string['user_moved'] = '"{$a->user}" has been moved from the queue of group "{$a->from_group}" to group "{$a->to_group}"!';
$string['user_move_prev'] = '"{$a->user}" will be moved from the queue of group "{$a->from_group}" to group "{$a->to_group}"!';
