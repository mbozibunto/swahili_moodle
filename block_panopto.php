...
/**
 * Strings for component 'block_panopto', language 'en', branch 'MOODLE_34_STABLE'
 *
...
$string['block_panopto_sync_after_provisioning_desc'] = 'Syncs all users enroled in a course after it has been provisioned. Turn on this option only if you have a problem with the default behavior which syncs a user\'s permission when each user accesses this block in one of the enroled courses.';
$string['block_panopto_sync_on_enrolment'] = 'Sync users after class enrolment';
$string['block_panopto_sync_on_enrolment_desc'] = 'This feature will fire a sync operation on a student any time they are enroled into a course with a valid Panopto folder. Turn on this option only if you have a problem with the default behavior which syncs a user\'s permission when each user accesses this block in one of the enroled courses.';
