...
/**
 * Strings for component 'auth_joomdle', language 'en', branch 'MOODLE_34_STABLE'
 *
...
$string['auth_joomdledescription'] = 'This method uses Joomdle web services to know whether a user has a valid session in Joomla, version 1.2';
