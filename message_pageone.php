...
/**
 * Strings for component 'message_pageone', language 'en', branch 'MOODLE_30_STABLE'
 *
...
$string['config_forum_help'] = 'Sends a text message notifying the user if a new message is posted to a forum they are subscribed to, no further notifications of new posts will be sent until the user returns to the form and makes a follow up posting. This is different to the standard forum posting notification setting which will send a message for every post. Using this option allows the number of text messages consumed by forum notifications to be restricted.  (Moodle 2.7+ only)';
$string['config_forum_user'] = 'Forum posting notification user default.';
$string['config_forum_user_help'] = 'Set the default used for the per user forum posting notification option. If forum posting notifications are disabled, the user option will be hidden.  (Moodle 2.7+ only)';
