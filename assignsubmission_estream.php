...
/**
 * Strings for component 'assignsubmission_estream', language 'en', branch 'MOODLE_34_STABLE'
 *
...
$string['enabled_help'] = 'If enabled, students are able to submit upload video/audio files for assessment via Planet eStream.';
