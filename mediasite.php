...
/**
 * Strings for component 'mediasite', language 'en', branch 'MOODLE_33_STABLE'
 *
 * @package   mediasite
...
$string['my_mediasite_placement_hint'] = '"Course Menu" adds this link to every course for enrolled users. "Site Home" is a more central location.';
