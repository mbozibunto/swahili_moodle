...
/**
 * Strings for component 'plagiarism_unplag', language 'en', branch 'MOODLE_33_STABLE'
 *
...
$string['unplag_enableplugin'] = 'Enable in {$a} activity';
...
$string['unplag_show_student_report'] = 'Show reports to students';
...
$string['unplag_show_student_score'] = 'Show scores to students';
