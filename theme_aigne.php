...
/**
 * Strings for component 'theme_aigne', language 'en', branch 'MOODLE_30_STABLE'
 *
 * @package   theme_aigne
...
$string['usermenu'] = 'On the Header, in new user menu style (login + dropdowm menu)';
$string['usermoodle'] = 'On the Header, in moodle old-fashioned style (login + user name + logout)';
