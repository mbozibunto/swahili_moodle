...
/**
 * Strings for component 'leganto', language 'en', branch 'MOODLE_34_STABLE'
 *
 * @package   leganto
...
$string['defaultdisplay_desc'] = 'By default, should new reading lists be displayed on a separate page via a link, or inline on the course page?';
$string['display'] = 'Display reading list contents';
$string['display_help'] = 'If you choose to display the reading list contents on the course page, there will be no link to a separate page. The description will be displayed only if "Display description on course page" is checked.';
