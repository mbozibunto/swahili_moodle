...
$string['error_incorrectcontenttype_full'] = 'Plugin detected Incorrect Content-Type in Response from Arlo API.

Response Content-type: {$a->contenttype}';
$string['error_incorrectcontenttype_fullhtml'] = '<p>Plugin detected Incorrect Content-Type in Response from Arlo API.<p>
<br>
...
$string['error_invalidcredentials_full'] = 'Moodle cannot connect to Arlo API
...
$string['error_invalidcredentials_fullhtml'] = '<h3>Moodle cannot connect to Arlo API</h3>
<br>
