...
/**
 * Strings for component 'tool_moodlebox', language 'en', branch 'MOODLE_34_STABLE'
 *
...
$string['privacy:metadata'] = 'The MoodleBox plugin displays information from the Raspberry Pi and enables some configuration changes, but does not effect or store any personal data itself.';
